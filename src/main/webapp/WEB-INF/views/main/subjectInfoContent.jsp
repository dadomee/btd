...
<html>
<head>
    <jsp:include page="subjectInfo.jsp" flush="false"/>
    <title>전공교과소개</title>
</head>
<body>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="icon-boxes d-flex flex-column justify-content-center">
                    <div class="row">
                        <div class="col-lg-3 d-flex align-items-stretch col-md-4 mt-4" data-aos="zoom-in" data-aos-delay="100">
                            <div class="icon-box iconbox-blue" style="width:500px; height:300px">
                                <div class="icon">
                                ...
                                <h4><a href="">학년 / 학기</a></h4>
                                <p>${subInfo.sub_semester}학년 / ${subInfo.sub_semester}학기</p>
                            </div>
                        </div>

                        <div class="col-lg-3 d-flex align-items-stretch mt-4 " data-aos="zoom-in" data-aos-delay="200">
                            <div class="icon-box iconbox-orange " style="width:500px; height:300px">
                                <div class="icon">
                                    <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h4><a href="">유형(전공 / 일반)</a></h4>
                                <p>${subInfo.sub_type}</p>
                            </div>
                        </div>

                        <div class="col-lg-3 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
                            <div class="icon-box iconbox-pink" style="width:500px; height:300px">
                                <div class="icon">
                                    <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
