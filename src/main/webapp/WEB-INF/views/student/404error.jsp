...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="../bootstrap/student/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
...
<div class="container-xxl container-p-y">
    <div class="misc-wrapper">
        ...
        <a href="${pageContext.request.contextPath}/student" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
            <img
                    src="../bootstrap/student/assets/img/illustrations/page-misc-error-light.png"
