            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item open">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="ㄱ404페이지.html" class="menu-link">
                                <div data-i18n="Blank">포상/징계</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-fluid.html" class="menu-link">
                ...
                <li class="menu-item open">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">학습 정보</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item open">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Authentications">종합 신청 정보</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                <div class="avatar avatar-online">
                                    <img src="../bootstrap/student/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                            </a>
